...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7892805795').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003515041061').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003515041061'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003758676689'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003515041061'))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
AUTH_CHANNELS = [int(ch) for ch in environ.get("AUTH_CHANNELS", "-1003758676689").split() if ch and id_pattern.match(ch)]
AUTH_REQ_CHANNELS = [int(ch) for ch in environ.get("AUTH_REQ_CHANNELS", "-1003758676689").split() if ch and id_pattern.match(ch)]
REQST_CHANNEL = int(ch) if (ch := environ.get("REQST_CHANNEL", "-1003515041061")) and id_pattern.search(ch) else None
SUPPORT_CHAT_ID = int(ch) if (ch := environ.get("SUPPORT_CHAT_ID", "-1003515041061")) and id_pattern.search(ch) else None
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anujedits:anujedits@cluster0.tc5voup.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Anujedits")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anujedits')
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1003515041061'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003515041061'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/xqNtSMpS/photo-2025-09-18-15-24-38-7551450511015149572.jpg")
TUTORIAL = environ.get("TUTORIAL", "https://t.me/log_channel_a/238")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/log_channel_a/238")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/log_channel_a/238")
SHORTENER_API = environ.get("SHORTENER_API", "372b23dabae021f93ca15408fc7a674ec4ec2ce3")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shrink.pe")
SHORTENER_API2 = environ.get("SHORTENER_API2", "372b23dabae021f93ca15408fc7a674ec4ec2ce3")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shrink.pe")
SHORTENER_API3 = environ.get("SHORTENER_API3", "372b23dabae021f93ca15408fc7a674ec4ec2ce3")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "shrink.pe")
